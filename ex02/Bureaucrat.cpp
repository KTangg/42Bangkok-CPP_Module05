...
/*   Updated: 2022/05/24 20:19:56 by spoolpra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form &form) const
{
	...
	{
		std::cout << *this << " couldn’t sign " << form << " because Bereaucrat grade too low" << std::endl;
	}
}
...
void	Bureaucrat::executeForm(Form const &form) const
{
	...
	{
		std::cerr << *this << " grade to low to execute " << form << std::endl;
	}
	catch (Form::UnsignedFormException &e)
	{
		std::cerr << form << " isn't signed yet" << std::endl;
	}
}
